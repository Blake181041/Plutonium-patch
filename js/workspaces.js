...
(function () {
  ...
  const views = {
    games: `<section class="workspace-view workspace-games" data-workspace="games">
      ...
      <div id="viewer-bar" class="bar-hidden" role="toolbar" aria-label="Game controls"><div class="viewer-zone viewer-zone--identity"><img class="viewer-bar__logo" id="viewer-bar-logo" src="img/logos/icon-plutonium-pink.png" alt="" draggable="false"><div class="viewer-meta"><span class="viewer-bar__title" id="viewer-title"></span><span class="viewer-meta__sub"><i class="fa-solid fa-gamepad viewer-meta__icon"></i><span id="viewer-timer">0:00</span></span></div></div><div class="viewer-zone viewer-zone--transport"><button class="viewer-btn" id="vbtn-reload" title="Reload game" aria-label="Reload game"><i class="fa-solid fa-rotate-right"></i></button><button class="viewer-btn" id="vbtn-fullscreen" title="Fullscreen" aria-label="Toggle fullscreen"><i class="fa-solid fa-expand"></i></button><button class="viewer-btn" id="vbtn-hide" title="Hide bar" aria-label="Hide bar"><i class="fa-solid fa-chevron-down"></i></button></div><div class="viewer-zone viewer-zone--presence"><button class="viewer-save" id="viewer-save" type="button" title="Save sync"><i class="fa-solid fa-cloud"></i><span>Save sync on</span></button><button class="viewer-btn viewer-btn--exit" id="vbtn-back" title="Back to games" aria-label="Back to games"><i class="fa-solid fa-arrow-left"></i></button></div></div><div id="viewer-bar-ghost"></div><div id="viewer-bar-hint" role="status">Press left Shift to bring up the bottom bar</div>
    </section>`,
  ...
  window.Workspaces = { activate, deactivate, reload, build, has: key => !!views[key], get active() { return activeKey; } };
})();
